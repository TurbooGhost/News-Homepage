// const hamburguerMenuBttn = document.querySelector(".header__hamburguer-menu") as HTMLElement;
// const closeBttn = document.querySelector(".header__nav__close-icon") as HTMLElement;
